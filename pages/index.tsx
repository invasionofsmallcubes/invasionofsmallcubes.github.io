  ...
  return (
    <Layout home>
      ...
      2020</a>
        ...
        <p>
          <a href="https://github.com/invasionofsmallcubes/elementary-programming-dtu/tree/master/presentations">Slides for Elementary Programming held at DTU (Copenhagen) on the Winter 2020 Semester</a>
        </p>
      </section>
      <section className={`${utilStyles.headingMd} ${utilStyles.padding1px}`}>
